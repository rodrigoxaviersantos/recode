...
//  há apenas 3 clientes de acordo com o saldo médio no
//   último ano. Faça um programa em JAVA que leia uma lista
//    com saldo médio dos clientes e calcule o valor do crédito
//     de acordo com a tabela a seguir. Imprimir uma mensagem informando
//      o saldo médio e o valor de crédito. A lista termina com um saldo negativo.
...
public class SpecialCreditCalculator {
    public static void main(String[] args) {
        final double JUROS = 0.02; // Taxa de juros de 2%
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // Aplica o juros
            valorCredito += valorCredito * JUROS;
